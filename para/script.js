    ...
    let Memory = {
        ...
        buildHTML: function(){
            ...
            this.$cards.each(function(k, v){
				...
				alt="'+ v.name +'" /></div>\
				<div class="back"><img src="img/mariya1.jpg"\
				alt="Codepen" /></div></div>\
				</div>';
            });
    ...
    let cards = [
        {
            ...
            name: "php",
            // адрес картинки
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457289.png",
            // порядковый номер пары
            id: 1,
        },
        {
            name: "oven",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457374.png",//oven//
            id: 2
        },
        {
            name: "kettle",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457400.png",//kettle
            id: 3
        },
        {
            name: "jquery",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457394.png",
            id: 4
        },
        {
            name: "lopatka",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457281.png",//lopatka
            id: 5
        },
        {
            name: "node",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457324.png",
            id: 6
        },
        {
            name: "photoshop",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457273.png",
            id: 7
        },
        {
            name: "ambar",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457296.png",
            id: 8
        },
        {
            name: "vilka",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457303.png",
            id: 9
        },
        {
            name: "venchik",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457388.png",
            id: 10
        },
        {
            name: "juicer",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457382.png",
            id: 11
        },
        {
            name: "scale",
            img: "https://cdn-icons-png.flaticon.com/512/7457/7457362.png",
            id: 12
        },
    ];
